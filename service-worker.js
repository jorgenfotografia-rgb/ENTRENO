const CACHE='pitbull-academy-products-v2';
const ASSETS=['./','./index.html','./styles.css','./catalog.css','./app.js','./data/products.js','./data/module.js','./data/clients.js','./manifest.webmanifest',

...
const actionMap={glutamine:'RECOMMEND_PRODUCT',other:'RECOMMEND_CATEGORY',none:'DEFER_SUPPLEMENT',ask:'ASK_MORE'};
window.SCENARIOS.m01={
  id:'m01',
  clients:(window.CLIENTS||[]).map((c,i)=>({...c,answer:actionMap[c.answer]||c.answer,bossChallenge:i===5})),
  bossCheck:{
    afterCaseIndex:2,
